...
namespace lawiet\src;

use lawiet\src\NuSoapBase;
use lawiet\src\NuSoapFault;
use lawiet\src\NuSoapWSDL;
use lawiet\src\NuSoapXMLSchema;
...
class NuSoapServer extends NuSoapBase {
    ...
    function serialize_return()
    {
        ...
        // if fault
        if (isset($this->methodreturn) && is_object($this->methodreturn) && ((get_class($this->methodreturn) == 'NuSoapFault') || (get_class($this->methodreturn) == 'NuSoapFault'))) {
